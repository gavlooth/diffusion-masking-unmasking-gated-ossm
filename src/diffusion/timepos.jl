...
"""
    Lux.initialparameters(rng, l::TimePosEncoding)

Returns a `NamedTuple` `(P = …, time = (Wt1 = …, bt1 = …, Wt2 = …, bt2 = …))`.
The nested `NamedTuple` stores the weight matrices and biases of ``g``.
"""
...
function (l::TimePosEncoding)(
   ...
   start_pos::Int = 1,
    ...
    t_vec = Float32[t]                      # creates a 1-element Vector{Float32}
